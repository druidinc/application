    ...
    <div class="homeMenu">        
        <div class="menuSide">
            <ul class="ul">
                ...
                <li class="menu_selected"><a href="#">Contact Us</a></li>            
            </ul>
      ...
      <div class="page02ColumnOne">
        ...
        <div class="page02ColumnTwo">
            <div class="contactUsMapWrapper">
                <div class="contactUsMapTitle">
                    <h2>JCA BOOKKEEPING SERVICES INCORPORATED</h2>
                ...
                <div class="contactUsDataMap">
                        <img src="{$image}/lapulapumap.PNG">
                </div><!--End of contactUsDataMap-->
