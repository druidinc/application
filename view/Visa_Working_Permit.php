    ...
    <div class="page02Body">
      <div class="page02ColumnOne">
        <ul class="verticalMenu">
          {foreach from=$services item=categories}
                ...
                {foreach from=$categories.subcat item=subcategories}
                    <li class="{if $subcategories.subcat_name == 'Visas & Work Permit'}category_selected{/if}"><a href="{$base_url}Home/service?cat_id={$categories.cat_id}&subcat_id={$subcategories.subcat_id}" id="subcat_{$subcategories.subcat_id}_{$categories.cat_id}">{$subcategories.subcat_name}</a></li>
                {/foreach}
            {/foreach}                      
        </ul>
        <!--contact widget-->
        ...
        <div class="page02ColumnTwo">
            <div class="aboutUs">
                <div class="aboutUsTile"><h2>{$display_text}</h2></div>
                <p class="aboutUsBody">{$content}</p>
            </div><!--End of aboutUs-->
