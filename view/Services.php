        ...
        <div class="page02ColumnTwo">
            ...
            {section name=serviceIndex loop=$all_services}
                <div class="page02ColumnTwo_01" style="text-overflow:ellipsis;" id="{$all_services[serviceIndex].category_id}_{$all_services[serviceIndex].id}">
                    ...
                    <!--<span style="position:absolute" class="readmore" id="readmore_{$all_services[serviceIndex].category_id}_{$all_services[serviceIndex].id}" onclick="readMore(this.id,'{$all_services[serviceIndex].category_id}_{$all_services[serviceIndex].id}')">Read more...</span>-->
