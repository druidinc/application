	...
	<div class="col span_2_of_2 left services">
		{foreach from=$services item=categories}
			...
			{foreach from=$categories.subcat item=subcategories}
				<div class="col span_2_of_2 service 
					{if isset($cat_id) && $categories.cat_id == $cat_id && isset($subcat_id) && $subcategories.subcat_id == $subcat_id}
						selected_service
					{elseif $service[0].subcat_name == 'Peachtree (Sage 50)' && $subcategories.subcat_name == $service[0].subcat_name}selected_service
					{elseif $service[0].subcat_name == 'Visas & Work Permit' && $subcategories.subcat_name == $service[0].subcat_name}selected_service
					{/if}">
