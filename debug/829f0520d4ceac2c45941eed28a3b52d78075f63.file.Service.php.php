<?php /* Smarty version Smarty-3.1.13, created on 2013-05-05 15:28:39
         compiled from "application\view\Service.php" */ ?>
<?php /*%%SmartyHeaderCode:2108951865e87dbf463-63194424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '829f0520d4ceac2c45941eed28a3b52d78075f63' => 
    array (
      0 => 'application\\view\\Service.php',
      1 => 1367660598,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2108951865e87dbf463-63194424',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51865e8803f984_12186588',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51865e8803f984_12186588')) {function content_51865e8803f984_12186588($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['selected']->value==((('subcat_').($_smarty_tpl->tpl_vars['subcategories']->value['subcat_id'])).('_')).($_smarty_tpl->tpl_vars['categories']->value['cat_id'])){?>category_selected<?php }else{ ?>none<?php }?>">
...
?>
            <div class="page02ColumnTwo_01" style="height:100%;border:0px !important; width: 412px !important" id="<?php echo $_smarty_tpl->tpl_vars['all_services']->value[$_smarty_tpl->getVariable('smarty')->value['section']['serviceIndex']['index']]['category_id'];?>
...
">
            ...
            <div class="page02ColumnTwo_02" style="height:100%;border:0px !important; padding-left:0 !important"  id="img_<?php echo $_smarty_tpl->tpl_vars['all_services']->value[$_smarty_tpl->getVariable('smarty')->value['section']['serviceIndex']['index']]['category_id'];?>
_<?php echo $_smarty_tpl->tpl_vars['all_services']->value[$_smarty_tpl->getVariable('smarty')->value['section']['serviceIndex']['index']]['id'];?>
">
                <img  style="border:1px solid #bbb !important;border-style:inset;" src="<?php echo $_smarty_tpl->tpl_vars['image']->value;?>
